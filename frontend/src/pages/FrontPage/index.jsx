              ...
              {authUser ? (
                <>
                  <button
                    ...
                    className="bg-gradient-to-r from-blue-500 to-purple-600 text-white px-4 py-2 rounded-full font-medium hover:shadow-lg transition-all duration-300 flex items-center justify-center"
                  >
                    <span className="mr-2">💬</span> Chat with Mentor
                  </button>
                  <Link to="/profile" className="text-gray-700 hover:text-orange-500 transition-colors duration-300 font-medium text-center">{authUser.name}</Link>
                  <button onClick={handleLogout} className="text-white bg-gray-800 hover:bg-gray-900 px-4 py-2 rounded-full font-medium transition-colors">Logout</button>
                </>
              ) : (
                <>
